    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximum_shares_percentage_per_partner', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
                ('maximum_active_credits_per_partner', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
                ...
                ('payment_period_of_installment', models.PositiveIntegerField(default=0)),
                ('credit_investment_relationchip', models.DecimalField(decimal_places=4, default=0.0, max_digits=10)),
