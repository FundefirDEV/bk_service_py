# Generated by Django 3.2 on 2022-03-14 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date time on which the object was created', verbose_name='create at')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date time on which the object was last modified', verbose_name='modified at')),
                ('ordinary_interest', models.DecimalField(decimal_places=4, default=3.0, max_digits=100)),
                ('delay_interest', models.DecimalField(decimal_places=4, default=5.0, max_digits=100)),
                ...
                ('expenditure_fund_percentage', models.DecimalField(decimal_places=4, default=5.0, max_digits=100)),
                ('reserve_fund_of_bad_debt_percentage', models.DecimalField(decimal_places=4, default=5.0, max_digits=100)),
                ('payment_period_of_installment', models.PositiveIntegerField(default=30)),
                ('credit_investment_relationship', models.DecimalField(decimal_places=4, default=5, max_digits=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profit_obtained', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordinary_interest_paid', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
                ('delay_interest_paid', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordinary_interest_calculated', models.DecimalField(decimal_places=4, max_digits=100)),
                ('ordinary_interest_paid', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
                ('delay_interest_percentage', models.DecimalField(decimal_places=4, max_digits=100)),
                ('delay_interest_calculated', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
                ('delay_interest_base_amount', models.DecimalField(decimal_places=4, max_digits=100)),
                ('delay_interest_paid', models.DecimalField(decimal_places=4, default=0.0, max_digits=100)),
